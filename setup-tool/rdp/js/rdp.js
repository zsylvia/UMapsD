...
function handleClick(ev, secondTry) {
	var clickX = ev.offsetX + paperShiftX;
	var clickY = ev.offsetY + paperShiftY;
...
function changeBuildingFloor() {
	...
	"<option id='all_buildings' " + (currentBuilding ==  GlobalStrings.ALL_BUILDINGS ? "selected='true'" : "") + ">"+GlobalStrings.ALL_BUILDINGS+"</option>";
